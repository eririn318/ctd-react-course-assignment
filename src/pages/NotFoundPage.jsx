...
export default function NotfoundPage() {
    ...
    return(
        ...
        <h1 className="text-4xl font-black tracking-tight text-red-600 sm:text-5xl">404 error</h1>
        <h2 className="text-lg font-bold text-slate-700 mt-3 mb-15" >Page not found</h2>
