    ...
    return(
        <div style={{ padding: "2rem", maxWidth: "800px", margin: "0 auto" }}>
            ...
            <p className="text-base text-slate-500 leading-relaxed mt-7 mb-15">
                Welcome to our task management platform. This application is designed to help you 
        stay organized, track your daily responsibilities, and maintain focus on your goals
        </p>

        <section style={{ marginTop: "2rem" }}
        className="bg-white border border-slate-200 rounded-2xl p-10 shadow-sm space-y-4"
        >
            <h2 className="text-lg font-bold text-slate-900 tracking-wide uppercase text-md">Core Features</h2>
        ...
        <section style={{ marginTop: "2rem" }}
        className="bg-white border border-slate-200 rounded-2xl p-10 shadow-sm space-y-4">
               <h2 className="text-lg font-bold text-slate-900 tracking-wide uppercase text-md">Built With</h2>
              <div className="grid gap-3 sm:grid-cols-2 ">
