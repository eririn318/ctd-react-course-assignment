...
function StatusFilter() {
  ...
  const handleStatusChange = (status) => {
    //This is an event handler function that runs whenever a user clicks a filter button (for example, clicking an "Active", "Completed", or "All" tab) and passes along the newly chosen category.
    if (status === "all") {
